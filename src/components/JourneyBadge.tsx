...
function getStageColor(stage: JourneyStage): string {
  if (stage === 'mudou_area') return 'bg-amber-100 text-amber-700 border border-amber-300';
  if (stage === 'nao_retornou') return 'bg-red-100 text-red-600 border border-red-300';
  ...
  if (idx === 9) return 'bg-green-100 text-green-700 border border-green-300';
